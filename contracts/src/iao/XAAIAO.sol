...
contract XAAIAO is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    event Init(address owner, address tokenIn, address rewardToken, uint256 startTime, uint256 depositPeriodHours, uint256 totalReward, address xaaNFTHolder);
    ...
    function initialize(
        ...
        emit Init(owner, _tokenIn, _rewardToken, _startTime, depositPeriodHours, _totalReward, _xaaNFTHolder);
    }
